...
const Journey = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto -mt-10 py-12 px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col justify-center text-white md:ml-12">
          ...
          <p className="text-lg text-neutral-600 md:text-xl mt-6 md:mt-12 md:text-left">Discover the FitClub isn't just another gym; it's your partner in fitness excellence. With cutting-edge facilities and a vibrant community, we're here to help you smash your fitness goals and enjoy the journey along the way. Join us and discover a new level of energy, motivation, and results!</p>
          
          
          <div className="grid grid-cols-2 gap-6 md:grid-cols-2 mt-12 md:mt-40">
            <div className="text-left">
              <h3 className="text-5xl md:text-7xl font-bold">{Math.floor(years)}+</h3>
              <div className='border-b border-neutral-700 my-4'></div>
              <p className="mt-2 md:mt-4 text-xl md:text-2xl font-semibold">Years</p>
            </div>
            <div className="text-left">
              <h3 className="text-5xl md:text-7xl font-bold">{Math.floor(programs)}+</h3>
              <div className='border-b border-neutral-700 my-4'></div>
              <p className="mt-2 md:mt-4 text-xl md:text-2xl font-semibold">Programs</p>
            </div>
            <div className="text-left">
              <h3 className="text-5xl md:text-7xl font-bold">{Math.floor(zones)}+</h3>
              <div className='border-b border-neutral-700 my-4'></div>
              <p className="mt-2 md:mt-4 text-xl md:text-2xl font-semibold">Zones</p>
            </div>
            <div className="text-left">
              <h3 className="text-5xl md:text-7xl font-bold">{Math.floor(classes)}+</h3>
              <div className='border-b border-neutral-700 my-4'></div>
              <p className="mt-2 md:mt-4 text-xl md:text-2xl font-semibold">Classes</p>
            </div>
          </div>
        </div>
      </div>
